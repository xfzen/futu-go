...
import (
	...
	"futuq/pkg/proto/qotgetoptionchain"
	"futuq/pkg/protocol"
)
...
func (api *FutuAPI) GetOptionChain(ctx context.Context, owner *Security, begin string, end string,
	indexOptType qotcommon.IndexOptionType, optType qotcommon.OptionType, cond qotgetoptionchain.OptionCondType, filter *DataFilter,
) ([]*OptionChain, error) {
	// 请求参数
