...
import (
	...
	"futuq/pkg/proto/common"
	"futuq/pkg/proto/getglobalstate"
	"futuq/pkg/proto/initconnect"
	"futuq/pkg/proto/keepalive"
	"futuq/pkg/proto/notify"
...
func (api *FutuAPI) initConnect(ctx context.Context, clientVer int32, clientID string, recvNotify bool,
	encAlgo common.PacketEncAlgo, protoFmt common.ProtoFmt, lang string,
) (*initConnectResp, error) {
	// 请求参数
